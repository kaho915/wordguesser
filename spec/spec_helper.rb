...
def stub_random_word(word)
  stub_request(:get, 'https://randomword.saasbook.info/RandomWord.txt').to_return(body: word)
end
...
RSpec.configure do |config|
  ...
  config.before do
    stub_request(:get, "https://randomword.saasbook.info/RandomWord.txt").to_return(body: "foobar")
  end
  config.color = true
